  ...
  return (
    <>
            ...
            {Array(count)
                .fill("")
                .map((_, index) => (
                    <div key={index} className="bg-gray-200 dark:bg-gray-700 rounded-2xl shadow p-6 animate-pulse flex flex-col items-center">
                        <div className="w-28 h-28 rounded-full bg-gray-300 dark:bg-gray-600 mb-4" />
                        <div className="w-2/3 h-4 bg-gray-300 dark:bg-gray-600 mb-2 rounded" />
                        <div className="w-1/2 h-3 bg-gray-300 dark:bg-gray-600 mb-4 rounded" />
